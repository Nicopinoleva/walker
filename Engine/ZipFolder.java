...
public class ZipFolder {
    ...
    public static void zipper(String Files_location, String Zip_location_name) throws Exception {
        ZipFolder obj = new ZipFolder();
        obj.zipFolder(new File(Files_location),
                new File(Zip_location_name));
    }
