...
SALES_FILE_FORMAT = OPTION_ARGS[15]
SALES_ORDER = OPTION_ARGS[16]
SALES_DELIMITATOR = OPTION_ARGS[17]
SALES_HEADER = OPTION_ARGS[18]
SALES_DATE_FORMAT = OPTION_ARGS[19]
SALES_UNITS_CONVERSION = OPTION_ARGS[20]
SALES_UNITS_DECIMAL = OPTION_ARGS[21]
SALES_AMOUNT_CONVERSION = OPTION_ARGS[22]
SALES_AMOUNT_DECIMAL = OPTION_ARGS[23]
STOCK_FILE_FORMAT = OPTION_ARGS[24]
STOCK_ORDER = OPTION_ARGS[25]
STOCK_DELIMITATOR = OPTION_ARGS[26]
STOCK_HEADER = OPTION_ARGS[27]
STOCK_DATE_FORMAT = OPTION_ARGS[28]
STOCK_UNITS_CONVERSION = OPTION_ARGS[29]
STOCK_UNITS_DECIMAL = OPTION_ARGS[30]
STOCK_AMOUNT_CONVERSION = OPTION_ARGS[31]
STOCK_AMOUNT_DECIMAL = OPTION_ARGS[32]
ENCODING = OPTION_ARGS[33]
