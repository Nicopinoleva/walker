...
def Get_file():
    ...
    global MATRIX
    hoy = today()
    nueva_fecha = issued_day-timedelta(days=6)
    nueva_fecha2 = issued_day
    ...
    if get_downloads_count() < 2:
        ...
        if get_downloads_count() == 0:
            ...
            repeat(4):
                press(TAB)
            time_wait(2000)
            name1 = RUT_EMPRESA + "_" + date_to_string(nueva_fecha,"%Y%m%d") + "_" + date_to_string(nueva_fecha2,"%Y%m%d") + "_" + NOMBRE_EMPRESA + "_JUMBO_SI_B2B_DIA" 
            type(name1)
            time_wait(2000)
            ...
            time_wait(2000)
            name2 = RUT_EMPRESA +  "_" + date_to_string(nueva_fecha2,"%Y%m%d") + "_" + date_to_string(nueva_fecha2,"%Y%m%d") + "_" + date_to_string(nueva_fecha2,"%Y%m%d") + "_" + NOMBRE_EMPRESA + "_JUMBO_SI_B2B_DIA_INV"
            type(name2)
            time_wait(2000)
            image_click("Save.png")
            time_wait(1000)
        ...
        if Screenshots_taken == 0:
            ...
            nueva_fecha2 = issued_day
            name = RUT_EMPRESA +  "_" + date_to_string(date,"%Y%m%d") + "_" + date_to_string(nueva_fecha2,"%Y%m%d") + "_" + NOMBRE_EMPRESA + "_JUMBO_SI_B2B_MENSUAL"
            ...
            name = RUT_EMPRESA +  "_" + date_to_string(nueva_fecha,"%Y%m%d") + "_" + date_to_string(fecha2,"%Y%m%d") + "_" + NOMBRE_EMPRESA + "_JUMBO_SI_B2B_MENSUAL"
            screenshot_save_crop(name,11,230,1325,700)
